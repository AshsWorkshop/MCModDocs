...
const config: Config = {
  ...
  organizationName: 'Ashwork', // Usually your GitHub org/user name.
  projectName: 'mcmoddocs', // Usually your repo name.
  ...
  themeConfig: {
    ...
    footer: {
      ...
      <p>Copyright © ${new Date().getFullYear()} Ashwork LLC. Built with Docusaurus.</p>
      `,
    },
    prism: {
